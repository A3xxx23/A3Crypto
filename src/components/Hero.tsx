        ...
        <div className="flex items-center justify-center mt-10 w-full">
            <div className="relative w-full max-w-xl mx-auto">
                <input
                    ...
                    className="w-full p-2 sm:p-5 bg-white/5 border border-gray-600 rounded-lg text-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-600 text-lg" 
                />
